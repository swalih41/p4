...
const navigate = useNavigate();
  ...
  return (
    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      />
    <Navbar className="navbarCSS shadow-lg" collapseOnSelect expand="lg" style={{position: 'relative', zIndex: "2 !important", backgroundColor:"rgb(195 211 198 / 66%)"}}>
      {/* <Navbar className="navbarCSS" collapseOnSelect expand="lg" bg="dark" variant="dark"> */}
        ...
        <Navbar.Collapse id="responsive-navbar-nav" style={{color: "white"}}>
          {user ? (
            ...
            <>
              <Nav>
                <Button variant="success" onClick={handleShowLogin} className="ml-2">Login</Button>
              </Nav>
            </>
          )}
